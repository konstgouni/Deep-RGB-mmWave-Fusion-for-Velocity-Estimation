...
The reported estimation performance and inference latency correspond to inference using the following hardware:

  A laptop with an Intel Core $i7-12700H$ CPU.
  16 gigabytes of RAM.
  An nVIDIA GeForce RTX $3060$ graphics processing unit (GPU) with 8 gigabytes of dedicated video memory.
...
Should there be any issue with running the code and replicating the inference, please contact me via one of the email addresses: kgounis@ece.auth.gr, konstgouni@csd.auth.gr
